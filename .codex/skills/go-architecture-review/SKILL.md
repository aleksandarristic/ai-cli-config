...
description: Review Go repository architecture, identify hotspots and risks, and propose a prioritized improvement roadmap.
---

## Method
- Identify core domain logic vs adapters (I/O boundaries).
- Map dependencies and coupling (packages, shared state, cross-package reach).
...
## Output
- Architecture summary (packages + responsibilities)
- Top risks (with file/package references)
