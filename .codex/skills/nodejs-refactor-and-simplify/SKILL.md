---
name: nodejs-refactor-and-simplify
description: Refactor and simplify Node.js code in a moderately complex repository while preserving behavior and improving maintainability/performance where justified.
---

## Purpose
Make targeted refactors that reduce complexity and future-proof a Node.js codebase without changing externally observable behavior unless explicitly requested.

## Operating principles
- Preserve behavior by default. If behavior must change, call it out explicitly and minimize blast radius.
- Prefer small, reviewable changes over large rewrites.
- Match existing repo conventions (style, async patterns, logging, error handling, structure).
